    ...
    <div id='about' className='w-[80%] px-[5%] py-20 scroll-mt-20 ml-[10%]'>
        ...
        <div className='flex flex-col lg:flex-row items-center py-10 mt-8'>
            ...
            <div className='relative max-w-[250px] h-[270px] rounded-3xl mb-[30px] overflow-hidden'>
                <Image src={'/profile_pic.png'} alt="user" width={300} height={270} className='rounded-2xl object-cover object-fill' priority/>
                <Image src={'/assets/tape.png'} alt="tape" width={120} height={60} className='absolute top-0 left-1 -rotate-45 -translate-x-8'/>
            </div>
            ...
            <div className='flex-1'>
                ...
                <div className='relative w-[580px] h-[450px] mb-5 rounded-3xl overflow-hidden mx-auto'>
                    ...
                    src={'./assets/tornpaper_1.png'} alt="paper" priority fill="true" sizes="(max-width: 768px) 100vw, 580px" className='w-[400px] h-[300px] object-cover'/>
                    <motion.div 
                    initial={{opacity: 0}}
                    whileInView={{opacity:1}}
            ...
            <div className='inline-flex flex-col items-center justify-center gap-10'> 
                ...
                <div className='relative inline-flex flex-col items-center hover:translate-y-1 duration-300'>
                    <MotionImage
                        ...
                        whileInView={{y: 0, opacity:1}}
                        transition={{duration: 0.3, delay: 0.8}}
                        src={'./assets/colored_paper_1.png'}
                        alt="art link"
                        width={160}
                        height={170}
        ...
        <div className='flex flex-col items-center'>
            ...
            className='flex items-center justify-center flex-wrap gap-4 sm:gap-6 mt-6 max-w-[1000px] w-full'>
                {toolsData.map((tool, index)=>(
                    ...
                    key={index}>
                        <Image src={'./assets/taped_note_1.png'} alt="toolnote" fill="true" sizes="(max-width: 768px) 100vw, 580px" className='object-cover items-center'/>
